...
public class AvroDataLoader {
  private static final Logger logger = Logger.getLogger(AvroDataLoader.class);
  private static final String APP_NAME = "Avro_Data_Loader";

  public static void main(String[] args) throws Exception {
    AvroDataLoader loader = new AvroDataLoader();
    loader.execute(args);
  }
  ...
  public void execute(String[] args) throws Exception {
    ...
    AvroFileParams params = new AvroFileParams();
