...
@Deprecated
public class OrcLoaderConfig extends LoaderConfig {

  public static String paramDesc = "(<file_name> [<schemaFile>])";

  public IHateWeirdBugs fileParams() {
    OrcLoaderConfig.IHateWeirdBugs b = new OrcLoaderConfig.IHateWeirdBugs();
    b.config = this;
    return b;
  }

  public class OrcFileParamsIterator implements Iterator<OrcFileParams> {
    private final OrcLoaderConfig config;
    private int currIndex;
    private final int stride;

    public OrcFileParamsIterator(OrcLoaderConfig config, int startIndex) {
      this.config = config;
    ...
    @Override
    public OrcFileParams next() {
      OrcFileParams p = new OrcFileParams();
  ...
  public class IHateWeirdBugs implements Iterable<OrcFileParams> {
    private OrcLoaderConfig config;

    public Iterator<OrcFileParams> iterator() {
      return new OrcFileParamsIterator(config, iteratorStartIndex);
    }
  }
}
