package com.dataprofiler.datasetperformance.spec;
...
public class DatasetPerformanceSpec {
  ...
  public static DatasetPerformanceSpec fromJson(String json) throws IOException {
    ObjectMapper mapper = ObjectMapperFactory.initObjectMapper();
    return mapper.readValue(json, new TypeReference<DatasetPerformanceSpec>() {});
  }
