package com.dataprofiler.datasetquality.spec;
...
public class DatasetQualitySpec {
  ...
  public static DatasetQualitySpec fromJson(String json) throws IOException {
    ObjectMapper mapper = ObjectMapperFactory.initObjectMapper();
    return mapper.readValue(json, new TypeReference<DatasetQualitySpec>() {});
  }
