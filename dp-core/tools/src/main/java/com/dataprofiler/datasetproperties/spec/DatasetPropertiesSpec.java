package com.dataprofiler.datasetproperties.spec;
...
public class DatasetPropertiesSpec {
  ...
  public static DatasetPropertiesSpec fromJson(String json) throws IOException {
    ObjectMapper mapper = ObjectMapperFactory.initObjectMapper();
    return mapper.readValue(json, new TypeReference<DatasetPropertiesSpec>() {});
  }
  ...
  public Set<Action> getActions() {
    return unmodifiableSet(new HashSet<>(actions));
  }
