...
TIMEOUT_MINUTES=480
UI_ALTERNATE_OAUTH_CONSUMER_ID=xx
UI_ALTERNATE_OAUTH_CONSUMER_SECRET=xx
UI_ALTERNATE_OAUTH_SERVER=https://iapi/authentication
UI_ALTERNATE_USER_FACING_HTTP_PATH=https://alt.dataprofiler
UI_MAIN_OAUTH_CONSUMER_ID=xx
UI_MAIN_OAUTH_CONSUMER_SECRET=xx
UI_MAIN_OAUTH_SERVER=https://iapi/authentication
