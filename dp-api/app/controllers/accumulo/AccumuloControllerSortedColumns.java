...
@Authenticated
@AccumuloUserContext
public class AccumuloControllerSortedColumns extends Controller {
  ...
  @Inject
  public AccumuloControllerSortedColumns(Config config) throws IOException {
    this.config = config;
    this.accumulo = new AccumuloHelper();
  }
  public Result sortedColumns(Request req, String dataset, String table) {
    Context context =
        (com.dataprofiler.util.Context)
    ...
    return ok(Json.toJson(metadata.sortedColumnNames()));
  }
}