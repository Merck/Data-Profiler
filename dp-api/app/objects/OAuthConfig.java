  ...
  public JsonNode tokenRequest(String code) {
    ...
    try {
      HttpResponse<com.mashape.unirest.http.JsonNode> jsonResponse =
          Unirest.post(reqUrl).header("Accept", "application/json")
              .header("Content-Type", "application/x-www-form-urlencoded")
              .header("Authorization", authString).field("grant_type", "authorization_code")
              .field("code", code).field("redirect_uri", this.oAuthCallbackUrl).asJson();
