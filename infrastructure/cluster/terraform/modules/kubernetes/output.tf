...
*/
output "master_id" {
  description = "Instance ID of master instances"
...
output "master_tags" {
  ...
  value       = aws_instance.kubernetes_master.*.tags
}

output "worker_id" {
  description = "Instance ID of worker instances"
...
output "worker_private_dns" {
  ...
  value       = aws_instance.kubernetes_worker.*.private_dns
}
...
output "worker_tags" {
  ...
  value       = aws_instance.kubernetes_worker.*.tags
}
