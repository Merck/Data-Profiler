Most of this is vendored from https://github.com/tiagoapimenta/nginx-ldap-auth/

# Build

```
docker build -t container-registry.com/nginx-ldap-auth:latest .
docker push container-registry.com/nginx-ldap-auth:latest
```
