...
def test_datasets_search():
    # routes: 848
    # AccumuloControllerDatasets
    # POST /datasets/search controllers.accumulo.AccumuloControllerDatasets.searchDatasetNames(request: Request)
    body = {
    ...
    req_path = f'{BASE_API_PATH}/datasets/search'
