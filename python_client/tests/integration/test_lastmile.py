...
def test_lastmile_quality_graphql():
    # routes: 2258
    # QualityController
    # POST /lastmile/quality/graphql controllers.lastmile.QualityController.graphql(request: Request)
    body = {
        'query': '{findById(id: 8507){auditId auditSite}}'
    }
    req_path = f'{BASE_API_PATH}/lastmile/quality/graphql'
