# Dataset Performance Container

The purpose of this container is to calculate all or given dataset performance metrics using the datasetperformance-pipeline in tekton.
The computed data will correspond to the data in the ui3 list view data performance tab.
